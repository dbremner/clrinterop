...
namespace tlbimp2
{
    ...
    class ConvProperty
    {
        ...
        private readonly InterfacePropertyInfo m_propertyInfo;   // Information for the property generated by the IConvInterface
    }
    ...
    class PropertyInfo
    {
        ...
        private readonly InterfaceInfo m_info;  
        private readonly Dictionary<int, ConvProperty> m_properties = new Dictionary<int, ConvProperty>();
    }
}
